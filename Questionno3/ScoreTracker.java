...
public class ScoreTracker {
    ...
    public static void main(String[] args) {
        ...
        scoreTracker.addScore(85.5); // Current scores: [85.5]
        scoreTracker.addScore(92.3); // Current scores: [85.5, 92.3]
        scoreTracker.addScore(77.8); // Current scores: [85.5, 92.3, 77.8]
        scoreTracker.addScore(90.1); // Current scores: [85.5, 92.3, 77.8, 90.1]
        double median1 = scoreTracker.calculateMedianScore(); 
        System.out.println("Median 1: " + median1);

        // Adding more scores
        scoreTracker.addScore(81.2); // Current scores: [85.5, 92.3, 77.8, 90.1, 81.2]
        scoreTracker.addScore(88.7); // Current scores: [85.5, 92.3, 77.8, 90.1, 81.2, 88.7]
